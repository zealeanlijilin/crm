...
public class GenUtils
{
     ...
     * @return 模板列表
     */
    public static List<String> getTemplates(Integer genType)
    {
        ...
        if(genType==1){
            ...
            templates.add("templates/vm/java/domainPlus.java.vm");
            templates.add("templates/vm/java/MapperPlus.java.vm");
            templates.add("templates/vm/java/ServicePlus.java.vm");
            templates.add("templates/vm/java/ServiceImplPlus.java.vm");
            templates.add("templates/vm/java/ControllerPlus.java.vm");
            templates.add("templates/vm/xml/MapperPlus.xml.vm");
            templates.add("templates/vm/html/list.html.vm");
            templates.add("templates/vm/html/add.html.vm");
            templates.add("templates/vm/html/edit.html.vm");
            templates.add("templates/vm/sql/sql.vm");
    ...
    public static String getFileName(String template, TableInfo table, String moduleName)
    {
        ...
        if (template.contains("domain.java.vm")||template.contains("domainPlus.java.vm"))
        {
            return javaPath + "domain" + "/" + className + ".java";
        }

        if (template.contains("Mapper.java.vm")||template.contains("MapperPlus.java.vm"))
        {
            return javaPath + "mapper" + "/" + className + "Mapper.java";
        }

        if (template.contains("Service.java.vm")||template.contains("ServicePlus.java.vm"))
        {
            return javaPath + "service" + "/" + "I" + className + "Service.java";
        }

        if (template.contains("ServiceImpl.java.vm")||template.contains("ServiceImplPlus.java.vm"))
        {
            return javaPath + "service" + "/" + className + "ServiceImpl.java";
        }

        if (template.contains("Controller.java.vm")||template.contains("ControllerPlus.java.vm"))
        {
            return javaPath + "controller" + "/" + className + "Controller.java";
        }

        if (template.contains("Mapper.xml.vm")||template.contains("MapperPlus.xml.vm"))
        {
