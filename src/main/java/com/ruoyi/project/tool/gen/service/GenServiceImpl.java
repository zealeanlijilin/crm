...
public class GenServiceImpl implements IGenService
{
     ...
     */
    @Override
    public byte[] generatorCode(String tableName,Integer genType)
    {
        ...
        // 生成代码
        generatorCode(table, columns, zip,genType);
     ...
     */
    @Override
    public byte[] generatorCode(String[] tableNames,Integer genType)
    {
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        ZipOutputStream zip = new ZipOutputStream(outputStream);
     ...
     * 生成代码
     */
    public void generatorCode(TableInfo table, List<ColumnInfo> columns, ZipOutputStream zip,Integer genType)
    {
        // 表名转换成Java属性名
        ...
        // 获取模板列表
        List<String> templates = GenUtils.getTemplates(genType);
